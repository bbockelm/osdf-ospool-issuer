...
RUN curl -s -L https://github.com/ncsa/OA4MP/releases/download/v5.2.8.2/oauth2.war > /opt/tomcat/webapps/scitokens-server.war ;\
...
RUN curl -L -s https://github.com/ncsa/OA4MP/releases/download/v5.2.8.2/oa2-cli.jar >/opt/scitokens-server/lib/scitokens-cli.jar ;\
